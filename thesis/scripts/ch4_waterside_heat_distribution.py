"""Chapter 4 — 余热锅炉水侧吸热分配 (2HRSG1吸热分配.png, 2HRSG2吸热分配.png)"""
...
def main() -> None:
    ...
    for unit, fname in [(1, "2HRSG1吸热分配.png"), (2, "2HRSG2吸热分配.png")]:
        data = build_hrsg_data(df, unit)
        hp_top = data["hp_heat_mw"]
        ip_top = hp_top + data["ip_rh_heat_mw"]
        lp_top = ip_top + data["lp_heat_mw"]

        fig, ax = plt.subplots(figsize=(5, 4.5))
        for y, label in [(hp_top, "高压主蒸汽吸热"), (ip_top, "中压+再热吸热"), (lp_top, "低压主蒸汽吸热")]:
