...
df_raw = df_raw.resample("1min").mean()
...
# 依据转速进行筛选
df = df[df["shaft_rpm"] > 2950]
df = df.dropna()

df.to_csv(r"data_processing\for_degradation\outcome\jqrd_compressor_degradation1.csv", encoding="utf-8-sig", index=False)